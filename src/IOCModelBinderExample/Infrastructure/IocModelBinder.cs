...
namespace IOCModelBinderExample.Infrastructure
{
    /* !!!!!!!!!!!!!!!!!!!!!!!!!!!  IMPORTANT !!!!!!!!!!!!!!!!!!!!!
        ...
        1) The CreateModel method is removed (Lines 309-332 in original file) 
        2) The no longer used _modelCreator removed (Line 19 in original file) 
        3) The model is now created by ServiceProvider (Lines 63-66 in this file)
    */
    public class IocModelBinder : IModelBinder
    {
        ...
        /// </param>
        public IocModelBinder(IDictionary<ModelMetadata, IModelBinder> propertyBinders)
        {
